<?php
return array (
  '<strong>New Members</strong> Module Configuration' => '<strong> Novos membros </strong> Configuração do módulo',
  ...
  'Save' => 'Salvar',
  'The number of most actice users that will be shown.' => 'O número da maioria dos usuários ativos que serão mostrados.',
  'The panel title for the dashboard widget.' => 'O título do painel para o widget do painel.',
